...
STORE_VERSION = 1
STORE_KEY = "life180_reverse_cache"
...
HOT_MAP_KEY = "hot_map"
HOT_STORE_KEY = "life180_reverse_hits"
...
class ReverseGeocodeEndpoint(HomeAssistantView):
    url = "/api/life180/reverse_geocode"
    name = "api:life180/reverse_geocode"
    requires_auth = True
    ...
    async def get(self, request):
        ...
        async def _do_fetch_and_cache() -> Dict[str, Any]:
            ...
            headers = {
                "User-Agent": f"Life180/1.0 ({nom_email or 'no-contact'})",
