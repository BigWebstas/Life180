...
//     personId: 'alice',
//     stopIconHref: '/life180/images/stop24x24.png', // absolute/relative URL
//     includeRoute: true
//   });
//
...
export function buildKmlPositionsOnly(positions, options = {}) {
  ...
  ` : '';
    ...
    const docName = `Life180 ${firstIso} - ${lastIso}`;
